...
export const EDGE_STYLES: Record<IntelligenceRelationType, {
  ...
  // PM layer
  HAS_CONSTRAINT:    { color: '#DC2626', strokeWidth: 1, strokeDasharray: '4 3' },
  HAS_DECISION:      { color: '#8B5CF6', strokeWidth: 1.5 },
  HAS_FEATURE_GRAPH: { color: '#E879F9', strokeWidth: 1.5, strokeDasharray: '6 3' },
